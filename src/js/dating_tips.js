...
console.log("😊 dating_tips.js: SUCCESSFULLY IMPORTED!");
...
const tips= { 
  tip_1: {
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_1.svg",
    tipAlt: "A hand making the 'thumbs down' gesture over a broken heart.",
    tipThumbnailClass: "dating-tips__thumbnail",
    tipFullScreenClass: "dating-tips__full_screen",
  ...
  tip_2: {
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_2.svg",
  ...
  tip_3: {
    ...
    <p>Successful women hear this one all the time - “You're probably still single because men are intimidated by you!”</p>
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_3.svg",
  ...
  tip_4: {
    ...
    tipText: `
    <p class="utility_classes__center">It's because the date went “BLAH!”</p>
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_4.svg",
  ...
  tip_5: {
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_5.svg",
  ...
  tip_6: {
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_6.svg",
  ...
  tip_7: {
    ...
    tipText: `
    <p>It is if you're divorced, find yourself settling, date the same “type” over and over, or say yes to a mediocre match.</p>
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_7.svg",
  ...
  tip_8: {
    ...
    <p>I call this “listening for compatibility” and it's important because, without compatibility, you'll struggle to turn a promising romance into a lasting partnership.</p>
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_8.svg",
  ...
  tip_9: {
    ...
    <p>We all know psycho-babble when we hear it. “How does that make you feel?” “I've worked on myself.” Leave the “I” statements and feeling talk for later. Give yourself time to get to know your date and give your date time to get to know you, before steering the conversation into deeper water.</p>
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_9.svg",
  ...
  tip_10: {
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_10.svg",
  ...
  tip_11: {
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_11.png",
  ...
  tip_12: {
    ...
    tipText: `
    <p>After a great first date, clients always ask me: “What should I do now?”</p>
    <p>My answer is simple: “I want you to do <em>absolutely nothing</em>.”</p>
    ...
    <p>Why? Most men like to take the lead and women need to encourage them! Yes, they also like to know that you're interested and that you're not playing hard to get. But in their minds, there's a fine line between encouraging and pursuing. Send them a “thank you” email or text after a great night out and you risk stepping over that line.</p>
    <p>Remember men are natural hunters when it comes to dating. So, hold back … for now. He'll come after you if he's interested. Promise.</p>
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_12.svg",
  ...
  tip_13: {
    ...
    `,
    tipSource: "/assets/images/resources/dating-tips/tip_13.svg",
...
function createGallery() {
  const gallery = document.querySelector("section#dating-tips__gallery_modal div#dating-tips__tips_container");
  console.log(`dating_tips.js: STARTING: CREATE DATING TIPS GALLERY.`) 
  for (const tip in tips) {
    console.log(`...dating_tips.js: ➰ Entering 'for in' loop...`);
      ...
      <a class="utility_classes__reset image_modal__open" href="${tips[tip].tipLinkFullScreen}">
        ...
        <div class="image_modal__full_screen_bg" id="${tips[tip].tipIdFullScreen}">
          <div class="image_modal__full_screen" id="${tips[tip].tipLinkFullScreen}">
            <a href="${tips[tip].tipLinkThumbnail}" class="utility_classes__reset image_modal__close dating-tips__thumbnail_link"></a>
            <div
